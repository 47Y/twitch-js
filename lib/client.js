        ...
        case 'USERNOTICE':
          {
            if (msgid === 'resub') {
              ...
              this.emit('ritual', { channel: channel, username: _username3, type: type, userstate: _userstate4 });
				 ...
				 var _username4 = message.tags['display-name'] || message.tags.login;
				 var _plan4 = message.tags['msg-param-sub-plan'];
				 var _planName4 = _.replaceAll(_.get(message.tags['msg-param-sub-plan-name'], null), {
				   '\\\\s': ' ',
				   '\\\\:': ';',
				   '\\\\\\\\': '\\',
				   '\\r': '\r',
				 ...
				 var _bombAmount4 = message.tags['msg-param-mass-gift-count'];
				 var _totalGiftAmount4 = message.tags['msg-param-sender-count'];
				 var _userstate4 = message.tags;

				 if (_userstate4) {
				   _userstate4['message-type'] = 'submysterygift';
				 }

				 this.emit('submysterygift', channel, _username4, _bombAmount4, _totalGiftAmount4, { plan: _plan4, planName: _planName4 }, _userstate4);
			  }
            break;
          }
...
client.prototype._openConnection = function _openConnection() {
  this.ws = new ws((this.secure ? 'wss' : 'ws') + '://' + this.server + ':' + this.port + '/', 'irc', { host: this.opts.options.ip || 'localhost' });
